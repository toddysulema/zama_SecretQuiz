...
function isFhevmRelayerSDKType(
  ...
  // v0.9 uses ZamaEthereumConfig, but SepoliaConfig may still exist for backward compatibility
  // At least one config must exist
  const hasZamaConfig = objHasProperty(o, "ZamaEthereumConfig", "object", trace);
